  ...
  const kranConfigs: KranConfig[] = [
    {
      ...
      className: 'furnance-carbonization-kran-1',
    },
    {
      key: 'ИМ2 ХВО',
      ...
      valueKey: 'ИМ2 ХВО',
      orientation: 'horizontal',
      className: 'furnance-carbonization-kran-2',
    },
    {
      ...
      orientation: 'horizontal',
      className: 'furnance-carbonization-kran-3',
    },
    {
      ...
      orientation: 'horizontal',
      className: 'furnance-carbonization-kran-4',
    },
    {
      ...
      orientation: 'horizontal',
      className: 'furnance-carbonization-kran-5',
      threshold: 5,
    },
  ];
